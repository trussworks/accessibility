...
- [Accessibility Conformance Report (ACR) for the Trusted Tester Process spreadsheet with automated WCAG 2.0 and disability impact reports](https://github.com/trussworks/accessibility/wiki/VPAT-spreadsheet-with-automated-WCAG-2.0-and-disability-impact-report)
